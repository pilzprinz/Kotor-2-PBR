#version 120
// Faithful GLSL port of fp_worldtex_env_reflective ARB + shadow_receive.inc.
// Pairs with vp_static_env_fog.vs.glsl. Diffuse + lightmap + envmap + fog + shadow.
...
void main()
{
    ...
    outC = min(outC, 1.0);  // prevent bloom from overbright spec/sun
